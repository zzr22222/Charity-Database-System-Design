      ...
      <div class="columns">
         <div class="column is-12">
            <div class="block has-text-centered">
               <h1 class="is-capitalize text-lg">We need your help</h1>
            </div>
         </div>
      </div>
   </div>
	...
	<div class="container">
		<div class="columns is-multiline">
			<div class="column is-6-desktop is-6-tablet">
				<p class="is-size-5 mb-5">Help a child discover the joy of learning and join us in our efforts to put Every Child
					in School!</p>
				<p>If he is in pain, he will be considered helpless. They just left something broken, and then they were born. What is the sin of children, they should not easily find cheating? Except what.</p>

				<div class="member-benifit mt-5">
					<h4 class="mb-4">Charity Notification</h4>
					<p class="mb-3">As a charity you will need to know:</p>
      ...
      <!-- contact form about zip -->
      <section class="contact-wrap section-bottom">
        <div class="container">
          <div class="columns is-multiline">
            <div class="column is-12">
              <form action="addzip.php" method="post">
                <span class="text-color">Send a message</span>
                <h3 class="text-md mb-5">We Need Your Zip First!</h3>
                <!-- end message -->
                <div class="column is-12-desktop is-6-tablet">
                  <label>Your Zip *</label>
                  <input name="zip" type="number" class="input">
                </div>
                <div class="column is-12-desktop is-6-tablet">
                ...
                <div class="column is-12-desktop is-6-tablet">
                  ...
                  <input name="state" type="text" class="input">
                </div>
                <div class="column is-6">
                  <!--              <a href="addzip.php" class="btn btn-main-2 is-rounded">Submit</a>-->
                  <input type="submit" class="btn btn-main-2 is-rounded" value="SUBMIT">
                </div>
              </form>
            </div>
          </div>
			...
			<div class="column is-6-desktop is-6-tablet">
				...
				<h2 class="mb-5 text-md">Charity Information Registration</h2>
				<form action="addcharity.php" method="post" class="volunteer-form">
          <div class="mb-4">
            <input type="number" name="cid" class="input" placeholder="Charity ID">
          </div>
          <div class="mb-4">
            <input type="number" name="caid" class="input" placeholder="Category ID">
          </div>
          <div class="mb-4">
            <input type="text" name="cn" class="input" placeholder="Charity Name">
          </div>
          <div class="mb-4">
            <input type="text" name="add" class="input" placeholder="Address">
          </div>
          <div class="mb-4">
            <input type="text" name="zip" class="input" placeholder="Zip">
          </div>
          <div class="mb-4">
            <input type="text" name="tel" class="input" placeholder="Telephone">
          </div>
          <div class="mb-4">
            <input type="text" name="rev" class="input" placeholder="2005 Revenue">
          </div>
          <div class="mb-4">
            <input type="text" name="pe" class="input" placeholder="ProgramExpenses">
          </div>
          <div class="mb-4">
            <input type="text" name="ae" class="input" placeholder="AdminExpenses">
          </div>
          <div class="mb-4">
            <input type="text" name="fe" class="input" placeholder="FundraisingExpenses">
          </div>
          <input type="submit" class="btn btn-main-2 is-rounded" value="SUBMIT!" >
<!--          <a href="confirmation1.html" class="btn btn-main-2 is-rounded mt-3">Submit!</a>-->
				</form>
			</div>
		</div>
	</div>
