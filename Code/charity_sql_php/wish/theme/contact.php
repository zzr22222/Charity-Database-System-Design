		...
		<div class="container">
			...
			<div class="navbar-menu mr-0" id="navigation">
              ...
              <a class="navbar-item" href="donation.php">Donation</a>
							<a class="navbar-item" href="volunteer.php">Be a Volunteer</a>
						</div>
					</li>
      ...
      <div class="columns is-multiline">
         <div class="column is-12">
            <form action="adddonor.php" method="POST">
               <span class="text-color">Send a message</span>
               <h3 class="text-md mb-5">Donor Register Form</h3>
               <!-- end message -->
               <div class="columns is-multiline">
                 <div class="column is-6-desktop is-6-tablet">
                   <label>Your Donor ID *</label>
                   <input name="id" type="number" class="input">
                 </div>
                  <div class="column is-6-desktop is-6-tablet">
                 ...
                 <div class="column is-6-desktop is-6-tablet">
                  ...
                  <div class="column is-6-desktop is-6-tablet">
                     <label>Your Zip *</label>
                     <input name="zip2" type="text" class="input">
                  </div>
                 <div class="column is-12">
                   <label>Your Address *</label>
                   <textarea name="Address" type="text" class="input" rows="6"></textarea>
                 </div>
                  <div class="column is-6-desktop is-6-tablet">
                  ...
                  <div class="column is-12">
                      <input type="submit" class="btn btn-main-2 is-rounded" value="SEND MESSAGE" >
                  </div>
               </div>
            </form>
         </div>
